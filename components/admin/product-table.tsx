...
function EditProductDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        className={productDialogContentClass}
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="my-2 text-sm text-violet-100/65">
            Create, preview, edit, and retire live catalog items.
          </p>
        </div>
          ...
          ? products.map((product) => (
              <div
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                  <span
                    className={`rounded-full px-2 py-1 text-xs ${product.stock > 0 ? "bg-emerald-400/10 text-emerald-200 ring-1 ring-emerald-300/20" : "bg-rose-400/10 text-rose-200 ring-1 ring-rose-300/20"}`}>
        ...
        {products.length > 0 ? (
                ...
                <TableRow
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="max-w-md truncate text-xs text-violet-100/55">
                  ...
                  <TableCell>
                    <div className="flex flex-wrap gap-1 text-xs">
                      <span
                        className={`rounded-full px-2 py-1 ${product.stock > 0 ? "bg-emerald-400/10 text-emerald-200 ring-1 ring-emerald-300/20" : "bg-rose-400/10 text-rose-200 ring-1 ring-rose-300/20"}`}>
                        {product.stock > 0 ? "Live" : "Out of stock"}
                      </span>
                      <span className="rounded-full bg-white/8 px-2 py-1 text-violet-100/75 ring-1 ring-white/10">
                        Hydration {product.hydration_level ?? 4}/5
                      </span>
                      {product.transfer_ready && (
                        <span className="rounded-full bg-white/8 px-2 py-1 text-violet-100/75 ring-1 ring-white/10">
                          Transfer
                        </span>
                      )}
                      {product.complimentary_shipping && (
                        <span className="rounded-full bg-white/8 px-2 py-1 text-violet-100/75 ring-1 ring-white/10">
                          Shipping
                        </span>
                      )}
          ...
          <div className="grid justify-items-center gap-3 px-6 py-16 text-center">
            ...
            <div>
              ...
              <p className="mt-1 max-w-md text-sm text-violet-100/60">
                Upload your first product image, fill the product details, and
