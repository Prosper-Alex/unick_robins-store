...
create policy "Active delivery rates are public" on public.delivery_rates for select
using (is_active = true);

create policy "Admins can manage delivery rates" on public.delivery_rates for all
using (public.is_admin())
with check (public.is_admin());
